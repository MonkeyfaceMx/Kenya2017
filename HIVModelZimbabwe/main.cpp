...
int main(){
    ...
    FILE* ProjectZim;
    ProjectZim = fopen("/Users/pperezgu/Dropbox/Ageing in Kenya and Zimbabwe - project/MATLAB_Pablo copy/MATLAB copy/Test12.csv","w");    // Change name and file location here as applicable
